 ...
 * View to edit
 */
class Jm_video_galleriesViewCategory extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$canDo		= Jm_video_galleriesHelper::getActions();
		JToolBarHelper::title(JText::_('COM_JM_VIDEO_GALLERIES_TITLE_CATEGORY'), 'category.png');

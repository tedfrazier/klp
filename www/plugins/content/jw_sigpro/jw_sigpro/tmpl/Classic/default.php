  ...
  <div class="carousel-inner">
	<?php foreach($gallery as $count=>$photo): ?>
		<div class="<?php if($count==0) echo 'active';?> item">
			<img class="jm-image" src="<?php echo $photo->sourceImageFilePath; ?>" alt="<?php echo JText::_('JW_SIGP_LABELS_08').' '.$photo->filename; ?>" title="<?php echo JText::_('JW_SIGP_LABELS_08').' '.$photo->filename; ?>" />
		</div>
	<?php endforeach; ?>
  </div>
  <!-- Carousel nav -->

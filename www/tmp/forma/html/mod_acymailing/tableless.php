			...
			<div class="acymailing_form">
				 ...
				 if($params->get('showterms',false)){
					...
					<p class="acysubbuttons">
						...
						<input class="button left" type="submit" value="&#xf0e0;" name="Submit" onclick="try{ return submitacymailingform('optin','<?php echo $formName;?>'); }catch(err){alert('The form could not be submitted '+err);return false;}"/>

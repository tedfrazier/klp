<!--layout:JM Consilium News1,order:1-->
<?php
/*
#------------------------------------------------------------------------
    ...
    <?php foreach ($slides as $i => $slide): ?>
      <div class="slide-item " style="min-height:<?php print $jmnewspro_item_height; ?>px">
        <div class="slide-item-wrap">
          <div class="slide-item-wrap-item row-fluid">
            <?php if ($jmnewspro_show_title || $jmnewspro_show_desc || $jmnewspro_show_category): ?>
              <div class="<?php if ($jmnewspro_show_image) echo 'span6'; else echo 'span12'; ?> slide-item-desc-warp<?php print ($jmnewspro_hover) ? ' jmnewsprohover' : ''; ?>">
                <div class="slide-inner">
                  <?php if ($jmnewspro_show_title): ?>
                    <div class="slide-item-title"><h3 class="header"><?php print $slide->title; ?></h3></div>
                  <?php endif; ?>
                  ...
                  <?php if ($jmnewspro_show_readmore): ?>
                    <span class="slide-item-readmore"><a class="read-more" href="<?php print $slide->link ?>"><?php print $jmnewspro_readmore_text; ?><i class="fa fa-arrow-right"></i></a></span>
                  <?php endif; ?>
                </div>
              </div>
            <?php endif; ?>
			<?php if ($jmnewspro_show_image){ ?><div class="span2"></div><?php } ?>
			<?php if ($jmnewspro_show_image): ?>
              <div class="span4 slide-item-image clearfix">

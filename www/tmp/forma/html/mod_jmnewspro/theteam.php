...
<div class="jmnewspro theTeam row-fluid <?php echo $moduleclass_sfx; ?>  <?php echo ($params->get('jmnewspro_layout', 'default')) ? ' ' . $params->get('jmnewspro_layout', 'default') : '' ?>" id="jmnewspro-<?php print $module->id; ?>">
  <div class="slider">
            ...
            <?php if ($jmnewspro_show_image): ?>
              <div class="slide-item-image theTeamUsersAvatarWrap clearfix">
                <?php if ($jmnewspro_image_link): ?>
                  <a href="<?php print $slide->link; ?>"><span class="theTeamUserAvatarBorder"><img class="theTeamUserAvatar" src="<?php echo $slide->getMainImage(); ?>"><i class="circle-border"></i></span></a>
                <?php else: ?>
                  <span class="theTeamUserAvatarBorder"><img class="theTeamUserAvatar" src="<?php echo $slide->getMainImage(); ?>"><i class="circle-border"></i></span>
                <?php endif; ?>
              </div>
            <?php endif; ?>
            <?php if ($jmnewspro_show_title || $jmnewspro_show_desc): ?>
                ...
                <div class="slide-inner">
                  <?php if ($jmnewspro_show_title): ?>
                    ...
                    <div class="theTeamNameWrap slide-item-title clearfix">
                        <div class="theTeamUsersName"><h3 class="title header"><?php echo $tmp[0]; ?></h3></div>
                        <div class="theTeamUsersType"><?php echo $tmp[1]; ?></div>
                    </div>
                  <?php endif; ?>
                  <?php if ($jmnewspro_show_desc): ?>
                      <?php $des= explode('|',$slide->description);?>

...
$moduleId = $module->id;
?>
<div id="twitter<?php echo $moduleId; ?>" class="twitter_wrap jmtwitterroll <?php print $moduleclass_sfx;?>">
	<div class="jm-twitter-buttons-inner">
		<a class="jm-twitter-btn jm-twitter-pre" onclick="return false;" href=""><i class="fa fa-angle-left"></i></span></a>
		<a class="jm-twitter-btn jm-twitter-next" onclick="return false;" href=""><i class="fa fa-angle-right"></i></a>
	</div>
</div>
<style type="text/css">
...
<script type="text/javascript" src="<?php print JURI::root(true) ?>/modules/mod_jmtwitterroll/assets/js/twitter.search.noborder.js"></script>
<script type="text/javascript">

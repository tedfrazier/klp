...
<div class="jmnewspro <?php echo $moduleclass_sfx; ?>  <?php echo ($params->get('jmnewspro_layout', 'default')) ? ' ' . $params->get('jmnewspro_layout', 'default') : '' ?>" id="jmnewspro-<?php print $module->id; ?>">
  ...
  <?php if ($jmnewspro_show_nav_buttons): ?>
    <span class="jmnewspro-prev" onclick="javascript:{jQuery(this).parents('.jmnewspro').find('.bx-prev').trigger('click')}"><i class="fa fa-angle-left"></i></span>
    <span class="jmnewspro-next" onclick="javascript:{jQuery(this).parents('.jmnewspro').find('.bx-next').trigger('click')}"><i class="fa fa-angle-right"></i></span>
  <?php endif; ?>
</div>

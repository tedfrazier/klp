<!--layout:JM Consilium News2,order:2-->
<?php
/*
#------------------------------------------------------------------------
        ...
        <div class="slide-item-wrap">
          <div class="slide-item-wrap-item row-fluid">
			<?php if ($jmnewspro_show_image): ?>
              <div class="span5 slide-item-image clearfix">
			...
			<?php if ($jmnewspro_show_title || $jmnewspro_show_desc || $jmnewspro_show_category): ?>
              <div class="<?php if ($jmnewspro_show_image) echo 'span7'; else echo 'span12'; ?> slide-item-desc-warp<?php print ($jmnewspro_hover) ? ' jmnewsprohover' : ''; ?>">

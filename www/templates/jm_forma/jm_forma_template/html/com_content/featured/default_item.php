	...
	<div class="entry-meta muted clearfix">
		...
		<?php if ($params->get('show_create_date')) : ?>
			<time class="entry-info create-date <?php echo (Helix::direction()=='rtl')?'right':'left'; ?>" datetime="<?php echo $this->item->created; ?>">
				...
				<span><?php echo JText::sprintf('COM_CONTENT_CREATED_DATE_ON', JHTML::_('date',$this->item->created, JText::_('JM_DATE_FORMAT_LC4'))); ?></span>
			</time>
		<?php endif; ?>
		<?php //End Create Date ?>
		...
		<?php if ($params->get('show_publish_date')) : ?>
			<time class="entry-info publish-date <?php echo (Helix::direction()=='rtl')?'right':'left'; ?>" datetime="<?php echo $this->item->publish_up; ?>" pubdate="pubdate">
				<i class="fa fa-calendar <?php echo (Helix::direction()=='rtl')?'right':'left'; ?>"></i>
                <?php echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE_ON', JHtml::_('date',$this->item->publish_up, JText::_('JM_DATE_FORMAT_LC4'))); ?>
            </time>
		<?php endif; ?>

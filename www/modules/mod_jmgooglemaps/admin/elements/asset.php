    ...
    protected function getInput() {
      $doc = JFactory::getDocument();
			...
			if ($joomla_version <3) {
				...
				$doc->addScript(JURI::root() . $this->element['path'] . 'js/chosen.jquery.min.js');	
				$doc->addStyleSheet(JURI::root() . $this->element['path'] . 'css/chosen.css');
				$doc->addScript(JURI::root().$this->element['path'].'js/jmbase64.min.js');
				$doc->addScript(JURI::root().$this->element['path'].'js/colorpicker/colorpicker.js');
				$doc->addScript(JURI::root().$this->element['path'].'js/jmmakers.js');
				$doc->addScript(JURI::root().$this->element['path'].'js/jmstyles.js');
			...
			$doc->addStyleSheet(JURI::root().$this->element['path'].'js/colorpicker/colorpicker.css');
			return null;
    }

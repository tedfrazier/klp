...
$document->addStyleSheet(JURI::root(true).'/modules/mod_jmtwitterroll/assets/css/mod_jmtwitterroll.css');
$moduleId = $module->id;
?>
<div id="twitter<?php echo $moduleId; ?>" class="jmtwitterroll <?php print $moduleclass_sfx;?>"></div>
<style type="text/css">

...
?> 
<div class="<?php print $params->get('jmsocials_layout', 'default');?> jmsocials_wrap <?php echo $moduleclass_sfx; ?>" id="jmsocials_wrap<?php echo $module->id; ?>">
